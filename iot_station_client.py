...
MQTT_BROKER_HOST = "127.0.0.1"        # IP hoặc Domain của máy chủ chạy Mosquitto Broker
MQTT_BROKER_PORT = 1883               # Cổng MQTT Broker (mặc định 1883, TLS là 8883)
