        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title"><i class="bi bi-broadcast-pin text-primary"></i> Trạng Thái Vận Hành Hệ Thống</h5>
                </div>
                <div class="card-body">
                        ...
                        <div class="p-3 mb-4 rounded border" style="background-color: var(--bg-body);">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <p class="text-muted small mb-0">Khi tắt, toàn bộ hệ thống trạm sẽ chuyển sang trạng
                                        thái bảo trì và tạm dừng thu thập dữ liệu.</p>
                                </div>
                                <div class="form-check form-switch ms-3">
                                    <input class="form-check-input" type="checkbox" name="is_active"
                                        id="switch-monitoring-status" {{ $isSystemActive ? 'checked' : '' }} value="1"
                        ...
                        @forelse($stations as $st)
                            <div class="list-group-item p-3 d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <div class="text-muted small">Vùng: {{ $st->garden->name ?? 'Bắc Ninh' }} | Chu kỳ:
                                        {{ $st->data_interval ?? 60 }}s</div>
                                </div>
